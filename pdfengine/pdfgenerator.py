...
class DocumentProcessingOrchestrator:
    ...
    def process_document(self, specification: DocumentSpecification) -> bytes:
        ...
        try:
            ...
            print(f"[{datetime.now()}] Metadata fetched. Processing page images...")
            ...
            for page_number in range(1, total_pages + 1):
                print(f"[{datetime.now()}] Fetching image for page {page_number}...")
            ...
            print(f"[{datetime.now()}] All images fetched. Assembling PDF...")
            # Assemble final PDF document
            pdf_document = self._pdf_assembler.assemble_document(page_images, page_info)
            print(f"[{datetime.now()}] PDF Assembled successfully.")
